            ...
            <?php while($article = mysqli_fetch_assoc($getArticles)) { ?>
                <div class="w-full mb-3">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="flex justify-between border-b-2 border-t-2 p-2">
                            <div class="flex items-center">
                                <a href="#" class="mr-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="#cf4c4c" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z"/></svg>
                                </a>
                                <!-- count total likes -->
                                <?php
                            ...
                            <div class="flex items-center">
                                <a href="#" class="mr-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="hover:fill-[#200E32] transition duration-300 ease-in-out" height="24px" viewBox="0 -960 960 960" width="24px" fill="#6d6972"><path d="M480-320q75 0 127.5-52.5T660-500q0-75-52.5-127.5T480-680q-75 0-127.5 52.5T300-500q0 75 52.5 127.5T480-320Zm0-72q-45 0-76.5-31.5T372-500q0-45 31.5-76.5T480-608q45 0 76.5 31.5T588-500q0 45-31.5 76.5T480-392Zm0 192q-146 0-266-81.5T40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200Zm0-300Zm0 220q113 0 207.5-59.5T832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280Z"/></svg>
                                </a>
                                <p>0 views</p>
                            </div>
                        </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <!-- icon like -->
                                    ...
                                    <form action="./add_delete_like.php" method="post">
                                        <input type="hidden" value="<?php echo $article['id'] ?>" name="idArticle" id="">
                                        <?php if($userLike == 0) { ?>
